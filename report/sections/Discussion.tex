...
\subsubsection{Docker for Machine Learning Deployment}
...
To achieve these goals, Docker is used. Docker \footnote[3]{https://www.docker.com/} is an open source platform that offers container technologies, lightweight alternatives to \ac{VM}, allowing applications to be deployed in independent, self-contained environments, matching the exact requirements of the environment that the model was developed on \cite{dreyfus-schmidt_introducing_2020}. Containerization of models is becoming a popular solution to the difficulties of dependencies when deploying machine learning models. 
...
\subsubsection{Developing a Docker Container}
